...
export default defineConfig({
	...
	"plugins": [
		...
		{
			// prevent vite from trying to inject code into an extension file due to an `import()` in that file
	...
	"optimizeDeps": {
		...
		"include": [
			...
			"vscode/service-override/bulkEdit",
			...
			"vscode/service-override/accessibility",
			...
			"vscode/workers/languageDetection.worker"
		],
		"esbuildOptions": {
			"plugins": [{
				"name": "import.meta.url",
				"setup": function({ onLoad }) {
